 ...
 #-------------------------------------------------------------------------------------       
        ...
        buttons_template = ButtonsTemplate(
            ...
            title='สวัสดีค่ะ คุณ' + profile.display_name, text='ยินดีตอนรับเข้าสู่ร้านอาหารเวทมนต์ "TESR" กรุณากดเลือกเมนูด้านล่างนะ', actions=[
                ...
                URIAction(label='Help', uri='http://line.me/ti/p/~diode.pon'),
                ...
                MessageAction(label='Contact', text='contact')
            ])
        template_message = TemplateSendMessage(
...
#------------------------------------------------------------------------------------
        ...
        image_carousel_template = ImageCarouselTemplate(columns=[
            ...
            ImageCarouselColumn(image_url='https://scontent.fbkk1-5.fna.fbcdn.net/v/t1.0-9/39257910_1001737223342651_2649326881203027968_n.jpg?_nc_fx=fbkk1-6&_nc_cat=0&oh=1f7e267db3f16eb78bcf1e0ba4b9d33e&oe=5C1028B2',
                                action=URIAction(
