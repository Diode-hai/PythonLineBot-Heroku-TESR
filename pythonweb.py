...
def handle_text_message(event):
    ...
    if text == 'profile':
        ...
        confirm_template = ConfirmTemplate(text= 'Stone Cake' + ' ' + 'Are you sure about the menu?', actions=[
        ...
        image_carousel_template = ImageCarouselTemplate(columns=[
            ImageCarouselColumn(image_url='https://scontent.fbkk10-1.fna.fbcdn.net/v/t1.0-9/39270900_1001138990069141_124850395737489408_n.jpg?_nc_cat=0&oh=a8a7ae511aa0b109c87cf41242902786&oe=5BF34330',
