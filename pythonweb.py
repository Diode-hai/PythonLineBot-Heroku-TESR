...
#---------------------------------------------------------------------------------
 ...
 #-------------------------------------------------------------------------------------       
        ...
        buttons_template = ButtonsTemplate(
            title='สวัสดีค่ะ คุณ' + profile.display_name, text='ยินดีตอนรับเข้าสู่ร้านอาหารเวทมนต์ TESR ที่สามารถสั่งงานได้ด้วยระบบ Line Bot ได้ที่เมนูปุ่มด้านล่าง', actions=[
